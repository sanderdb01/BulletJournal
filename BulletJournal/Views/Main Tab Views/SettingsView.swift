      ...
      NavigationStack {
         Form {
            ...
            Section {
               ...
               Text("See whats new, as well as send your feedback about the app.")
            }
         ...
         .sheet(isPresented: $showWhatsNew) {
            ...
            let currentAppVersion = "\(version) (\(build))"
            WhatsNewView(version: currentAppVersion)
         }
         .feedbackMail(isPresented: $showingFeedbackMail,
                       onSent: {
            showMailSuccessToast = true
         })
         .toast(
                     isPresented: $showMailSuccessToast,
